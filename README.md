...
- Next, write whatever delay you want that text to be resent (this box is based on seconds).
- Finally, for the thresholds you can change the randomness of the intervals based on the numbers you put here (in milliseconds).
